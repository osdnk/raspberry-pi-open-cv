...
class VideoCap:
    ...
    """
    functions = {
        'face-recognition': ['face_detection'],
        'basic-threshold': ['threshhold_filter', 'threshold'],
        'gauss-threshold': ['threshold_gauss', 'block_size', 'c'],
        'sobel-det': ['sobel_edge_det', 'x derivative degree', 'y derivative degree'],
        'laplacian-det': ['laplacian_edge_detecion'],
        'canny-edge-det': ['canny_edge_det', 'min', 'max'],
        'none': ['none_filter'],
        'cartoon': ['cartoon_filter']
    }

    def none_filter(self, frame):
        return frame
